...
!(function(i, h, m, f, d, k, e) {
    ...
    g = (i.$Jease$ = {
      ...
      $InOutElastic: function(a) {
        ...
        var b = 0.45,
          d = 0.1125;
        return (a *= 2) < 1
          ? -0.5 * c.q(2, 10 * (a -= 1)) * c.sb(((a - d) * 2 * c.E) / b)
          : c.q(2, -10 * (a -= 1)) * c.sb(((a - d) * 2 * c.E) / b) * 0.5 + 1;
      },
      $InBack: function(a) {
        var b = 1.70158;
        return a * a * ((b + 1) * a - b);
  ...
  var b = (i.$Jssor$ = new function() {
    ...
    function Gb() {
      if (!L) {
        L = { Vc: "ontouchstart" in i || "createTouch" in h };
        var a;
        if (E.pointerEnabled || (a = E.msPointerEnabled))
          L.ie = a ? "msTouchAction" : "touchAction";
      }
      return L;
    }
    function u(g) {
      if (!r) {
        r = -1;
        if (
          qb == "Microsoft Internet Explorer" &&
          !!i.attachEvent &&
          !!i.ActiveXObject
        ) {
    ...
    var S = { $Top: f, $Right: f, $Bottom: f, $Left: f, H: f, I: f };
    j.wg = function(a) {
      var b = j.Tb();
      s(b, { Sd: "block", Ob: j.rb(a), $Top: 0, $Left: 0, H: 0, I: 0 });
      var d = j.Ud(a, S);
      j.Ib(b, a);
      j.bb(b, a);
      var e = j.Ud(a, S),
    ...
    j.ad = function(c, d) {
      ...
      if (c)
        if (b.me(c)) a = { W: a };
        else if (b.me(c.$Clip)) a.$Clip = { W: c.$Clip };
      a.W = a.W || d;
    ...
    j.Ld = function(o, j, s, t, D, E, p) {
      ...
      if (
        ...
        !a.$Clip.J &&
        !a.$Clip.N &&
        a.$Clip.$Right == p.$OriginalWidth &&
        a.$Clip.$Bottom == p.$OriginalHeight
      )
        a.$Clip = f;
      return a;
    };
        ...
        if (!A || t || i != r) {
          if (O) {
            ...
            if (J) {
              ...
              if (toDisablePointerEventsByAnimation != H)
                n = H = toDisablePointerEventsByAnimation;
            }
            if (!n && o.$Opacity != e) {
              var p = o.$Opacity < 0.001;
              if (p != I) n = I = p;
            }
            if (n != e) {
              n && b.zc(m, "none");
    ...
    s = (i.$JssorSlideshowFormations$ = new function() {
      ...
      h.$FormationCircle = function(d) {
        for (
          ...
          for (a = 0; a < f; a++)
            g(h, c.$Round(c.Yb(c.q(b - i, 2) + c.q(a - j, 2))), [a, b]);
        return h;
      };
      h.$FormationCross = function(d) {
        for (
          ...
          for (a = 0; a < f; a++)
            g(h, c.$Round(c.k(c.F(b - i), c.F(a - j))), [a, b]);
        return h;
      };
      h.$FormationRectangleCross = function(f) {
        for (
          ...
          for (a = 0; a < i; a++)
            g(j, c.$Round(k - c.m(d - c.F(b - d), e - c.F(a - e))) - 1, [a, b]);
        return j;
      };
    }());
  ...
  i.$JssorBulletNavigator$ = function() {
    ...
    a.A = function(d, c) {
      ...
      a.Jc = g = b.G({ $SpacingX: 10, $SpacingY: 10, $ActionMode: 1 }, c);
  ...
  var t = (i.$JssorCaptionSlideo$ = i.$JssorSlideo$ = function() {
      ...
      function O(c, f) {
        var e = [],
          d = b.B(c, "play");
        if (f && d) {
          var g = new t(c, u, { Fg: d });
          S.push(g);
          a.a(g, p.Rc, Y);
          a.a(g, p.xc, T);
        } else
          b.c(b.Eb(c), function(a) {
            e = e.concat(O(a, f + 1));
          });
        if ((!f && (!j || j & 16)) || (f && (!d || !(d & 16)))) {
          var h = K[b.B(c, "t")];
          h && e.push({ $Elmt: c, Xc: h });
        }
        return e;
      }
      function H(c, e) {
      ...
      function cb(o, p, g) {
        ...
        b.c(p, function(h) {
          ...
          var m = { $Easing: i, $OriginalWidth: g.H, $OriginalHeight: g.I },
          ...
          if (f.vb) g.vb = { xd: 0, wd: 0, Bd: 0, $Opacity: 0 };
          g = b.Sg(g, f);
        });
        if (a && e) {
          e.ef();
          ...
          if (a.pb < m) {
            ...
            j = new l(a.pb, n - i, { pc: n - a.pb, Oe: d });
            j.U(e, d);
          }
          h && a.gd.push(h);
          j && a.xe.push(j);
      ...
      a.A = function(l, g, f) {
        ...
        var h = u.$Breaks || [],
          c = h[b.B(e, "b")] || [];
        c = c.concat({ b: r, d: c.length ? 0 : f.$Idle || A || 0 });
        db(c);
        G && a.Hc(1e8);
        r = a.ub();
        D(a, w, d);
    ...
    j = (i.$JssorSlider$ = (i.module || {}).exports = function() {
      ...
      function xc(a) {
        return !(D & 1) && a - K < 0.0001;
      }
      function vc(a) {
        return !(D & 1) && Q - a < 0.0001;
      }
      function sb(a) {
        return !(D & 1) && (a - K < 0.0001 || Q - a < 0.0001);
      }
      function Sb(c, a, d) {
        !ib &&
          b.c(Z, function(b) {
      ...
      function Rc(e, h, o) {
        ...
        l.$ScaleSize = function(q, l, u) {
          ...
          if (!f) {
            f = b.wg(e);
            g = e.parentNode;
            j = { $Scale: b.B(e, n.Hf, 1), $AutoCenter: b.B(e, n.yb) };
            b.c(m, function(c, a) {
      ...
      function ed() {
        ...
        l.call(
          ...
          -1,
          2,
          { $Easing: g.$Linear, Ne: { Ob: Cc }, pc: q, $Reverse: Hb },
          b,
          { Ob: 1 },
          { Ob: -2 }
        );
      ...
      function dd(r, h) {
        var g = this,
          ...
          y,
          Q;
        l.call(g, -N, N + 1, { pc: D & 1 ? q : e, $Reverse: Hb });
        function G(a) {
          x && x.$Destroy();
          Vb -= B;
          B = 0;
          S(r, a, 0);
          O = d;
          x = new db.$Class(r, db, { $Idle: b.B(r, "idle", qc), ng: !t });
          x.$On(p.xc, X);
        }
        function Y() {
          x.Pc < db.Pc && G();
      ...
      function Gc(f) {
        if (Ib()) {
          ...
          a = wb(a + e, 0.5);
          var d = c.F(a - b);
          if (d < 1 && m.$SlideEasing != g.$Linear) d = c.q(d, 0.5);
          if ((!eb || !f) && Mb) z.sc(gc);
          else if (b == a) rc.uc();
          else z.Kc(b, a, d * Gb);
        }
      ...
      a.A = function(i, f) {
        ...
        db = b.G({ $Class: p }, m.$CaptionSliderOptions);
        ...
        I = m.$SlideWidth || yb;
        H = m.$SlideHeight || xb;
        gb = { H: I, I: H, $Top: 0, $Left: 0, Sd: "block", Ob: "absolute" };
        P = m.$SlideSpacing;
        nb = I + P;
        ob = H + P;
        F = S & 1 ? nb : ob;
        ...
        if (m.$HWA && (!b.bh() || Fb))
          Qb = function(a, c, d) {
            b.fh(a, { $TranslateX: c, $TranslateY: d });
          };
        b.z(u, Nb, "1");
        b.Y(x, b.Y(x) || 0);
        b.rb(x, "absolute");
